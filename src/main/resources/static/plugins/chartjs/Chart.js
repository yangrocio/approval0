...
(function(){
	...
	var helpers = Chart.helpers = {};
		...
		//-- Basic treeview utility methods
	var each = helpers.each = function(loopable,callback,self){
		...
		inherits = helpers.inherits = function(extensions){
			//Basic javascript inheritance based on the model created in Backbone.treeview
			var parent = this;
...
(function(){
	...
	Chart.Type.extend({
		...
		//Config is automatically merged by the core of Chart.treeview, and is available at this.options
		initialize:  function(data){
