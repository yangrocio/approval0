...
@Slf4j
@Controller
public class UploadXsjlListener extends AnalysisEventListener<Xsjl> {
...
//            LoggerFactory.getLogger(com.alibaba.easyexcel.test.demo.read.DemoDataListener.class);
    ...
    List<Xsjl> list = new ArrayList<Xsjl>();
    /**
     * 假设这个是一个DAO，当然有业务逻辑这个也可以是一个service。当然如果不用存储这个对象没用。
     */
    private XsjlDao xsjlDao;

    public UploadXsjlListener(XsjlDao xsjlDao) {
     ...
     */
    @Override
    public void invoke(Xsjl data, AnalysisContext context) {
