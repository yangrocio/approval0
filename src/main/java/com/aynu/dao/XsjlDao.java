...
public interface XsjlDao {
    List<Xsjl> selectXsjlByDetail(@Param("department") String department, @Param("username") String username,
    ...
    List<Xsjl> selectXsjlByDetail2(@Param("department") String department, @Param("username") String username,
                                   @Param("name") String name, @Param("start") String start, @Param("end") String end
            , @Param("judgestatus") String judgestatus, @Param("roletype") String roletype, @Param("XMName") String XMName
            , @Param("CYRY") String CYRY, @Param("Rank") String Rank);

    boolean insertXsjl(Xsjl xsjl);
    //删除功能  需要 tid  应该是 删除 一个集合类型的
    boolean deleteXsjl(@Param("list") List<String> list, @Param("number") String number, @Param("department") String department);
    int deleteById(@Param("list") List<String> list);
    Xsjl showXsjl(@Param("department") String department, @Param("number") String number, @Param("id") String id);
    ...
    List<Xsjl> selectXsjlByDiff(@Param("department") String department, @Param("number") String number,
    ...
    int insertExcel(List<Xsjl> list);

    @Update("UPDATE xsjl SET  fjsc=#{fjscName} WHERE xid=#{id}")
